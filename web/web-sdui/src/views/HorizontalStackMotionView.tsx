...
export const HorizontalStackMotionView: React.FC<{ props: MotionViewProps; currentFrame: number; config: MotionConfig }> = ({ props, currentFrame, config }) => {
  ...
  return (
    ...
    >
      {sections.map((section: any, index: number) => (
        <div key={index} style={{ width: `${section.percentage}%`, height: '100%', position: 'relative' }}>
