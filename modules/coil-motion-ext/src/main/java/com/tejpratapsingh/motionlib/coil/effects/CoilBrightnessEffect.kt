...
/**
 * A [MotionEffect] that applies a brightness filter transformation using Coil transformations.
 */
class CoilBrightnessEffect(
    ...
    override fun forFrame(frame: Int): MotionView {
        ...
        if (view is ImageView) {
            val transformation = BrightnessFilterTransformation(view.context, brightness)
