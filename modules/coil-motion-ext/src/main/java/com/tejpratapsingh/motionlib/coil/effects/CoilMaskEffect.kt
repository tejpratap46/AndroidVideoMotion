...
/**
 * A [MotionEffect] that applies a mask transformation using Coil transformations.
 */
class CoilMaskEffect(
    ...
    override fun forFrame(frame: Int): MotionView {
        ...
        if (view is ImageView) {
            val transformation = MaskTransformation(view.context, maskId)
