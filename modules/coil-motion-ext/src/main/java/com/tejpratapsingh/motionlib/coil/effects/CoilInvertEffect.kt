...
/**
 * A [MotionEffect] that applies an invert filter transformation using Coil transformations.
 */
class CoilInvertEffect(
    ...
    override fun forFrame(frame: Int): MotionView {
        ...
        if (view is ImageView) {
            val transformation = InvertFilterTransformation(view.context)
