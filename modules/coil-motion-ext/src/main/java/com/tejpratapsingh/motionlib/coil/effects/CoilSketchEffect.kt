...
/**
 * A [MotionEffect] that applies a sketch filter transformation using Coil transformations.
 */
class CoilSketchEffect(
    ...
    override fun forFrame(frame: Int): MotionView {
        ...
        if (view is ImageView) {
            val transformation = SketchFilterTransformation(view.context)
